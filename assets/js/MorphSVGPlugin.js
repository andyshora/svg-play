...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    var e = Math.PI / 180
      ...
      , d = function(r, n, o, i, a, s, h, l, f) {
        if (r !== l || n !== f) {
            ...
            O %= 360,
            R %= 360;
            var F, j, H, D = p(R, O), Q = u * o, E = c * o, U = c * -i, W = u * i, Z = D.length - 2;
            for (F = 0; Z > F; F += 2)
                j = D[F],
                H = D[F + 1],
                D[F] = j * Q + H * U + L,
      ...
      , m = function(e) {
        ...
        }).match(r) || [], M = [], C = 0, S = 0, A = b.length, y = 2, x = 0;
        if (!e || !isNaN(b[0]) || isNaN(b[1]))
            return c("ERROR: malformed path data: " + e),
            M;
        for (t = 0; A > t; t++)
            if (v = s,
            isNaN(b[t]) ? (s = b[t].toUpperCase(),
            h = s !== b[t]) : t--,
            o = +b[t + 1],
            i = +b[t + 2],
            h && (o += C,
            ...
            "M" === s)
                ...
                i = g,
                l.closed = !0),
                ("L" === s || Math.abs(C - o) > .5 || Math.abs(S - i) > .5) && (l[y++] = C + (o - C) / 3,
                l[y++] = S + (i - S) / 3,
                l[y++] = C + 2 * (o - C) / 3,
                l[y++] = S + 2 * (i - S) / 3,
                l[y++] = o,
      ...
      , v = function(e, t) {
        var r, n, o, i, a, s, h, l, f, g, u, c, p, d, m = 0, v = .999999, b = e.length, M = t / ((b - 2) / 6);
        for (p = 2; b > p; p += 6)
            for (m += M; m > v; )
                r = e[p - 2],
                n = e[p - 1],
      ...
      , z = function(e, t, r) {
        var n, o, i, a = e.length, s = C(e), h = C(t), l = h[0] - s[0], f = h[1] - s[1], g = N(e, t, 0, l, f), u = 0;
        for (i = 6; a > i; i += 6)
            o = N(e, t, i / 6, l, f),
            g > o && (g = o,
            u = i);
      ...
      , P = function(e, t, r, n, o, i) {
        var a, s, h, l, f, g = t.length, u = 0, c = Math.min(e.size || S(e), t[r].size || S(t[r])) * n, p = 999999999999, d = e.centerX + o, m = e.centerY + i;
        for (s = r; g > s && (a = t[s].size || S(t[s]),
        c <= a); s++)
            h = t[s].centerX - d,
            l = t[s].centerY - m,
            f = Math.sqrt(h * h + l * l),
      ...
      , T = function(e, t, r, n) {
        var o, i, a, s, h, l, f, g = t.length - e.length, u = g > 0 ? t : e, p = g > 0 ? e : t, d = 0, m = "complexity" === n ? y : x, b = "position" === n ? 0 : "number" == typeof n ? n : .8, C = p.length, N = "object" == typeof r && r.push ? r.slice(0) : [r], T = "reverse" === N[0] || N[0] < 0, L = "log" === r;
        if (p[0]) {
            if (u.length > 1 && (e.sort(m),
            t.sort(m),
            l = u.size || A(u),
            l = p.size || A(p),
            l = u.centerX - p.centerX,
            f = u.centerY - p.centerY,
            m === x))
                for (C = 0; C < p.length; C++)
                    u.splice(C, 0, P(p[C], u, C, b, l, f));
            if (g)
                for (0 > g && (g = -g),
                u[0].length > p[0].length && v(p[0], (u[0].length - p[0].length) / 6 | 0),
                C = p.length; g > d; )
                    s = u[C].size || S(u[C]),
            ...
            for (C = 0; C < e.length; C++)
                ...
                r && (i.closed || Math.abs(i[0] - i[i.length - 2]) < .5 && Math.abs(i[1] - i[i.length - 1]) < .5 ? "auto" === r || "log" === r ? (N[C] = r = z(i, o, 0 === C),
                0 > r && (T = !0,
                M(i),
                r = -r),
                w(i, 6 * r)) : "reverse" !== r && (C && 0 > r && M(i),
                w(i, 6 * (0 > r ? -r : r))) : !T && ("auto" === r && Math.abs(o[0] - i[0]) + Math.abs(o[1] - i[1]) + Math.abs(o[o.length - 2] - i[i.length - 2]) + Math.abs(o[o.length - 1] - i[i.length - 1]) > Math.abs(o[0] - i[i.length - 2]) + Math.abs(o[1] - i[i.length - 1]) + Math.abs(o[o.length - 2] - i[0]) + Math.abs(o[o.length - 1] - i[1]) || r % 2) ? (M(i),
                N[C] = -1,
                T = !0) : "auto" === r ? N[C] = 0 : "reverse" === r && (N[C] = -1),
      ...
      , L = function(e, t, r, n) {
        var o = m(e[0])
          , i = m(e[1]);
        T(o, i, t || 0 === t ? t : "auto", r) && (e[0] = b(o),
        e[1] = b(i),
        ("log" === n || n === !0) && c('precompile:["' + e[0] + '","' + e[1] + '"]'))
    }
      , G = function(e, t, r) {
      ...
      , q = function(e, t) {
        ...
        for ("reverse" === t ? (o = s - 1,
        r = -2) : (o = (2 * (parseInt(t, 10) || 0) + 1 + 100 * s) % s,
        r = 2),
        i = 0; s > i; i += 2)
            h += a[o - 1] + "," + a[o] + " ",
            o = (o + r) % s;
      ...
      , I = function(e, t) {
        var r, n, o, i, a, s, h, l = 0, f = parseFloat(e[0]), g = parseFloat(e[1]), u = f + "," + g + " ", c = .999999;
        for (o = e.length,
        r = .5 * t / (.5 * o - 1),
        n = 0; o - 2 > n; n += 2) {
            if (l += r,
            ...
            l > c)
                ...
                i = 1; l > c; )
                    u += (f + (s - f) * a * i).toFixed(2) + "," + (g + (h - g) * a * i).toFixed(2) + " ",
                    l--,
                    i++;
            u += s + "," + h + " ",
            f = s,
      ...
      , X = function(e, t) {
        var r = document.createElementNS("http://www.w3.org/2000/svg", "path")
          ...
          , o = n.length;
        for (t = "," + t + ","; --o > -1; )
            -1 === t.indexOf("," + n[o].nodeName + ",") && r.setAttributeNS(null, n[o].nodeName, n[o].nodeValue);
        return r
    }
      , V = function(e, t) {
        var r, o, i, a, s, h, l, f, g, u, c, p, d, m, v, b, M, C, S, A, y, x = e.tagName.toLowerCase(), w = .552284749831;
        return "path" !== x && e.getBBox ? (h = X(e, "x,y,width,height,cx,cy,rx,ry,r,x1,x2,y1,y2,points"),
        ...
        l = a * w,
        r = "M" + (o + a) + "," + i + " C" + [o + a, i + f, o + l, i + s, o, i + s, o - l, i + s, o - a, i + f, o - a, i, o - a, i - f, o - l, i - s, o, i - s, o + l, i - s, o + a, i - f, o + a, i].join(",") + "z") : "line" === x ? r = "M" + e.getAttribute("x1") + "," + e.getAttribute("y1") + " L" + e.getAttribute("x2") + "," + e.getAttribute("y2") : ("polyline" === x || "polygon" === x) && (g = (e.getAttribute("points") + "").match(n) || [],
        o = g.shift(),
        i = g.shift(),
        r = "M" + o + "," + i + " L" + g.join(","),
        "polygon" === x && (r += "," + o + "," + i + "z")),
      ...
      , R = function(e, t, r) {
        ...
        return (!h || o.test(e) || (e.match(n) || []).length < 3) && (i = h ? s.selector(e) : e && e[0] ? e : [e],
        i && i[0] ? (i = i[0],
        a = i.nodeName.toUpperCase(),
        t && "PATH" !== a && (i = V(i, !1),
        a = "PATH"),
        e = i.getAttribute("PATH" === a ? "d" : "points") || "",
        i === r && (e = i.getAttributeNS(null, "data-original") || e)) : (c("WARNING: invalid morph to: " + e),
        e = !1)),
        e
    }
      ...
      , F = _gsScope._gsDefine.plugin({
        ...
        init: function(e, t, r, n) {
            var o, a, s, p, d;
            return "function" != typeof e.setAttribute ? !1 : u ? ("function" == typeof t && (t = t(n, e)),
            o = e.nodeName.toUpperCase(),
            d = "POLYLINE" === o || "POLYGON" === o,
            "PATH" === o || d ? (a = "PATH" === o ? "d" : "points",
            ("string" == typeof t || t.getBBox || t[0]) && (t = {
                shape: t
            }),
            p = R(t.shape || t.d || t.points || "", "d" === a, e),
            d && i.test(p) ? (c("WARNING: a <" + o + "> cannot accept path data. " + O),
            !1) : (p && (this._target = e,
            e.getAttributeNS(null, "data-original") || e.setAttributeNS(null, "data-original", e.getAttribute(a)),
            s = this._addTween(e, "setAttribute", e.getAttribute(a) + "", p + "", "morphSVG", !1, a, "object" == typeof t.precompile ? function(e) {
                e[0] = t.precompile[0],
                e[1] = t.precompile[1]
            }
            : "d" === a ? G(t.shapeIndex, t.map || F.defaultMap, t.precompile) : B(t.shapeIndex)),
            s && (this._overwriteProps.push("morphSVG"),
            s.end = p,
            s.endProp = a)),
            u)) : (c("WARNING: cannot morph a <" + o + "> SVG element. " + O),
            !1)) : (window.location.href = "http://" + f + g + "?plugin=" + l + "&source=" + h,
            !1)
        },
        set: function(e) {
            var t;
    ...
    F.pathDataToBezier = function(e, t) {
        var r, n, o, i, a, h, l, f, g = m(R(e, !0))[0] || [], u = 0;
        if (t = t || {},
        f = t.align || t.relative,
        i = t.matrix || [1, 0, 0, 1, 0, 0],
        a = t.offsetX || 0,
        h = t.offsetY || 0,
        "relative" === f || f === !0 ? (a -= g[0] * i[0] + g[1] * i[2],
        h -= g[0] * i[1] + g[1] * i[3],
        u = "+=") : (a += i[4],
        h += i[5],
        f && (f = "string" == typeof f ? s.selector(f) : f && f[0] ? f : [f],
        f && f[0] && (l = f[0].getBBox() || {
            x: 0,
            y: 0
        },
